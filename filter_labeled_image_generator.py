...
class View:
    ...
    def get_vectorized_candidate_sites(self, selected_candidate_list):
        ...
        vectorizer = CandidateVectorizer(fasta_handler=self.fasta_handler)

        vectorized_sites = vectorizer.get_vectorized_candidates(chromosome_name=self.chromosome_name,
    ...
    def parse_region(self, start_position, end_position, thread_no):
        ...
        if vectorized_candidates is not None and vectorized_candidates.size > 0:
            ...
            # label the sites with VCF data
            labeled_candidates = self.get_labeled_candidate_sites(selected_candidate_list=predicted_candidates,
            ...
            if DEBUG_PRINT_CANDIDATES:
                ...
                print("predicted:", len(labeled_candidates))
            ...
            self.generate_candidate_images(labeled_candidates, image_generator, thread_no)

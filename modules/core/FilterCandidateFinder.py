...
class CandidateFinder:
    ...
    def parse_match(self, read_id, alignment_position, length, read_sequence, ref_sequence, read_base_qualities, read_mapping_quality):
        """
    ...
    def parse_insert(self, read_id, alignment_position, read_sequence, read_base_qualities):
        ...
        self.mismatch_count[alignment_position] += 1
        self._update_read_allele_dictionary(pos=alignment_position + 1, allele=allele, type=INSERT_ALLELE)
        self._update_insert_dictionary(read_id=read_id, pos=alignment_position, bases=read_sequence, qualities=read_base_qualities)
    ...
    def parse_cigar_tuple(self, cigar_code, length, alignment_position, ref_sequence, read_sequence, read_id, read_base_qualities, read_mapping_quality):
        """
    ...
    def parse_reads_and_select_candidates(self, reads):
        ...
        for pos in range(self.region_start_position, self.region_end_position):
            ...
            # find the sum of edits at this position across all observed candidate alleles
            ...
            candidate_record.extend(filtering_data)

            selected_alleles.append(candidate_record)
